"""Helpers for the ``foga inspect`` command."""
...
from ..config.models import FogaConfig, build_kind
...
def _build_build_context(config: FogaConfig, args: InspectArgs) -> dict[str, object]:
...
def _build_test_context(config: FogaConfig, args: InspectArgs) -> dict[str, object]:
...
def _build_deploy_context(config: FogaConfig, args: InspectArgs) -> dict[str, object]:
...
def _build_resolved_config(config: FogaConfig, args: InspectArgs) -> dict[str, object]:
